...
export const getAllJobs = () => async (dispatch) => {
  ...
  try {
    const response = await axios.get("https://jobs-apisb.herokuapp.com/Jobs/getalljobs");
...
export const postJob = (values) => async (dispatch) => {
  ...
  try {
    ...
    const response = await axios.post("https://jobs-apisb.herokuapp.com/Jobs/postjob", values);
...
export const editJob = (values) => async (dispatch) => {
  ...
  try {
    // eslint-disable-next-line
    const response = await axios.post("https://jobs-apisb.herokuapp.com/Jobs/editjob", values);
...
export const applyJob = (job) => async (dispatch) => {
  ...
  try {
    // eslint-disable-next-line
    const response = await axios.post("https://jobs-apisb.herokuapp.com/Jobs/applyjob", {job , user});
